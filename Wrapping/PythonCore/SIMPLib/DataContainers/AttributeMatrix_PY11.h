...
PySharedPtrClass<AttributeMatrix> pybind11_init_SIMPLib_AttributeMatrix(py::module& m)
{
  ...
  instance.def(py::init([](std::vector<size_t> var_0, QString var_1, AttributeMatrix::Type var_2) { return AttributeMatrix::Create(var_0, var_1, var_2); }))
      ...
      .def("addAttributeArray", &AttributeMatrix::addAttributeArray, py::arg("Name"), py::arg("Array"))
      /* Class instance method doesAttributeArrayExist */
      .def("doesAttributeArrayExist", &AttributeMatrix::doesAttributeArrayExist, py::arg("Name"))
      /* Class instance method removeAttributeArray */
      .def("removeAttributeArray", &AttributeMatrix::removeAttributeArray, py::arg("Name"))
      /* Class instance method renameAttributeArray */
      .def("renameAttributeArray", &AttributeMatrix::renameAttributeArray, py::arg("OldName"), py::arg("NewName"), py::arg("OverWrite"));

...
PySharedPtrClass<SIMPLH5DataReader> pybind11_init_SIMPLib_SIMPLH5DataReader(py::module& m)
{
  ...
  instance.def(py::init([]() { return SIMPLH5DataReader::New(); }))
      .def_static("New", &SIMPLH5DataReader::New)
      /* Class instance method openFile */
      .def("openFile", &SIMPLH5DataReader::openFile, py::arg("filePath"))
      ...
      .def("readDataContainerArrayStructure", &SIMPLH5DataReader::readDataContainerArrayStructure, py::arg("SIMPLH5DataReaderRequirements"), py::arg("err"));

 ...
 * initialized.
 */
PySharedPtrClass<EmptyFilter> pybind11_init_SIMPLib_EmptyFilter(py::module& m
#ifdef simpl_EXPORTS
                                                                ,
...
)
{
  ...
  PyAbstractFilterSharedPtrClass<EmptyFilter> instance(m, "EmptyFilter");
#endif

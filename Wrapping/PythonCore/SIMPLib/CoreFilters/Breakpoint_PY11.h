 ...
 * initialized.
 */
PySharedPtrClass<Breakpoint> pybind11_init_SIMPLib_Breakpoint(py::module& m
#ifdef simpl_EXPORTS
                                                              ,
...
)
{
  ...
  PyAbstractFilterSharedPtrClass<Breakpoint> instance(m, "Breakpoint");
#endif

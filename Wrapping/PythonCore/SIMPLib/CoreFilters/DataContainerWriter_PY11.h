 ...
 * initialized.
 */
PySharedPtrClass<DataContainerWriter> pybind11_init_SIMPLib_DataContainerWriter(py::module& m
#ifdef simpl_EXPORTS
                                                                                ,
...
)
{
  ...
  PyAbstractFilterSharedPtrClass<DataContainerWriter> instance(m, "DataContainerWriter");
#endif

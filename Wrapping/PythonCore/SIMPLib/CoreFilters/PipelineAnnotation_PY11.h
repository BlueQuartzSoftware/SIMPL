 ...
 * initialized.
 */
PySharedPtrClass<PipelineAnnotation> pybind11_init_SIMPLib_PipelineAnnotation(py::module& m
#ifdef simpl_EXPORTS
                                                                              ,
...
)
{
  ...
  PyAbstractFilterSharedPtrClass<PipelineAnnotation> instance(m, "PipelineAnnotation");
#endif

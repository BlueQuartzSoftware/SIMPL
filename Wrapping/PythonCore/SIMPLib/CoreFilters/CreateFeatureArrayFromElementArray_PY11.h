...
* initialized.
*/
PySharedPtrClass<CreateFeatureArrayFromElementArray> pybind11_init_simpl_CreateFeatureArrayFromElementArray(py::module &m, PySharedPtrClass<AbstractFilter>& parent)
{

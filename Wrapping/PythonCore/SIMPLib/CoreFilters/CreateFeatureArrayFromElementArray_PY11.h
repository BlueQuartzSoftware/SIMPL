 ...
 * initialized.
 */
PySharedPtrClass<CreateFeatureArrayFromElementArray> pybind11_init_SIMPLib_CreateFeatureArrayFromElementArray(py::module& m
#ifdef simpl_EXPORTS
                                                                                                              ,
...
)
{
  ...
  PyAbstractFilterSharedPtrClass<CreateFeatureArrayFromElementArray> instance(m, "CreateFeatureArrayFromElementArray");
#endif

 ...
 * initialized.
 */
PySharedPtrClass<ReadASCIIData> pybind11_init_SIMPLib_ReadASCIIData(py::module& m
#ifdef simpl_EXPORTS
                                                                    ,
...
)
{
  ...
  PyAbstractFilterSharedPtrClass<ReadASCIIData> instance(m, "ReadASCIIData");
#endif

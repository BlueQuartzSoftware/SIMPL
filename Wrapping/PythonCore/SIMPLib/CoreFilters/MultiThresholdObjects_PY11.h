 ...
 * initialized.
 */
PySharedPtrClass<MultiThresholdObjects> pybind11_init_SIMPLib_MultiThresholdObjects(py::module& m
#ifdef simpl_EXPORTS
                                                                                    ,
...
)
{
  ...
  PyAbstractFilterSharedPtrClass<MultiThresholdObjects> instance(m, "MultiThresholdObjects");
#endif

 ...
 * initialized.
 */
PySharedPtrClass<MultiThresholdObjects2> pybind11_init_SIMPLib_MultiThresholdObjects2(py::module& m
#ifdef simpl_EXPORTS
                                                                                      ,
...
)
{
  ...
  PyAbstractFilterSharedPtrClass<MultiThresholdObjects2> instance(m, "MultiThresholdObjects2");
#endif

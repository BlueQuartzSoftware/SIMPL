...
py::class_<StackFileListInfo>(mod, "FileListInfo")
  .def(py::init<>([] (int32_t paddingDigits, uint32_t ordering, int32_t startIndex,
    int32_t endIndex, int32_t incrementIndex, const QString& inputPath, const QString& filePrefix,

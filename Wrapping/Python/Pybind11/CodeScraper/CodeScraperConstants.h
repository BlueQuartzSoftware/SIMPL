...
const QString kSIMPL_STATIC_NEW_MACRO("PYB11_STATIC_NEW_MACRO");
const QString kSIMPL_FILTER_NEW_MACRO("PYB11_FILTER_NEW_MACRO");
const QString kSIMPL_SHARED_POINTERS("PYB11_SHARED_POINTERS");
const QString kSIMPL_FILTER_PARAMETER("PYB11_FILTER_PARAMETER");

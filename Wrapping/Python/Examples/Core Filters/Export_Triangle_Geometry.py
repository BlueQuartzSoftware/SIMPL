...
def export_triangle_geometry():
    ...
    import_file = sd.GetBuildDirectory() + "/Debug/Data/DREAM3DReview/TriangleConnectivity.csv"
    wizard_data = {
        "inputFilePath": import_file,
        "beginIndex": 2,
        "numberOfLines": 243,
    ...
    err = simplpy.data_container_writer(dca, sd.GetTestTempDirectory() + "/ExportTriangleGeometry.dream3d", True, False)
    if err < 0:
    ...
    err = simplpy.write_triangle_geometry(dca, "DataContainer", sd.GetBuildDirectory() +
                                          "/Debug/Data/Output/CoreFilterTests/output_nodes.txt",
                                          sd.GetBuildDirectory() +
                                          "/Debug/Data/Output/CoreFilterTests/output_triangles.txt")
    if err < 0:

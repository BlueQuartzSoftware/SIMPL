# Pipeline : Create Feature Array From Element Array Filter Test
...
def create_feature_array_from_element_array_test():
    ...
    err = simplpy.create_feature_array_from_element_array(dca,
                                                          ...
                                                          simpl.DataArrayPath("Small IN100",
                                                                              ...
                                                                              "FeatureIds"))
    if err < 0:
        print("CreateFeatureArrayFromElementArray ErrorCondition %d" % err)

    # Write to DREAM3D file
    err = sc.WriteDREAM3DFile(sd.GetBuildDirectory() +
                              "/Debug/Data/Output/CoreFilterTests/" + 
                              "CreateFeatureFromElementArray.dream3d",
                              dca)
    if err < 0:
...
if __name__ == "__main__":
    create_feature_array_from_element_array_test()

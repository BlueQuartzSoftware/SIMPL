...
def pipeline_test(dca):
    ...
    read_ang_data.InputFile = sd.GetBuildDirectory() + "/Debug/Data/SmallIN100/Slice_1.ang"
    ...
    write_stats_gen_odf_angle_file.OutputFile = sd.GetTestTempDirectory() + "/StatsGenODF.txt"

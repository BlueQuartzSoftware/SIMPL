...
def small_in100_full_reconstruction():
    ...
    err = orientation_analysis.read_h5_ebsd(dca, "Small IN100", "Phase Data", "EBSD Scan Data",
                                            ...
                                            "/Debug/Data/Output/Reconstruction/SmallIN100.h5ebsd",
    ...
    err = orientation_analysis.convert_orientations(dca, simpl.OrientationType.Euler, simpl.OrientationType.Quaternion,
    ...
    err = sc.WriteDREAM3DFile(sd.GetBuildDirectory() + "/Debug/Data/Output/Reconstruction/08_SmallIN100_Final.dream3d",
                              dca)
    if err < 0:

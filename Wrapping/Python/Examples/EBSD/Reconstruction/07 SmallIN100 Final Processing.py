...
def small_in100_final_processing():
    ...
    err = d3d.data_container_reader(dca,
                                    ...
                                    "/Debug/Data/Output/Reconstruction/06_SmallIN100_Postsegmentation.dream3d",
                                    False, "", dt, dcap)
    if err < 0:
    ...
    err = sc.WriteDREAM3DFile(sd.GetBuildDirectory() + "/Debug/Data/Output/Reconstruction/SmallIN100_Final.dream3d",
                              dca)
    if err < 0:

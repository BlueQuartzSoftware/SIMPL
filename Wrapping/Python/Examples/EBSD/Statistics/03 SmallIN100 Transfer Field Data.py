...
def small_in100_transfer_field_data():
    ...
    err = d3d.data_container_reader(dca,
                                    sd.GetBuildDirectory() + "/Debug/Data/Output/Statistics/SmallIN100_Morph.dream3d",
                                    False, "", dt, dcap)
    if err < 0:
    ...
    err = sc.WriteDREAM3DFile(
        sd.GetBuildDirectory() + "/Debug/Data/Output/Statistics/SmallIN100_TransferFieldData.dream3d",
        dca)
    if err < 0:

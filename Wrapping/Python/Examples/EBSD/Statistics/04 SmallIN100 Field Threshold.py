...
def small_in100_field_threshold():
    ...
    err = d3d.data_container_reader(dca,
                                    ...
                                    "/Debug/Data/Output/Statistics/SmallIN100_TransferFieldData.dream3d",
                                    False, "", dt, dcap)
    if err < 0:
    ...
    err = sc.WriteDREAM3DFile(sd.GetBuildDirectory() + "/Debug/Data/Output/Statistics/SmallIN100_CopyCritical.dream3d",
                              dca)
    if err < 0:

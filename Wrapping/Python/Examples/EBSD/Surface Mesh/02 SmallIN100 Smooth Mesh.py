...
def small_in100_smoothmesh():
    ...
    err = d3d.data_container_reader(dca, sd.GetBuildDirectory() + "/Debug/Data/Output/SurfaceMesh/SmallIN100.dream3d",
                                    False, "", dt, dcap)
    if err < 0:
    ...
    err = sc.WriteDREAM3DFile(sd.GetBuildDirectory() + "/Debug/Data/Output/SurfaceMesh/SmallIN100_Smoothed.dream3d",
                              dca)
    if err < 0:

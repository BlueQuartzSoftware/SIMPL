...
def single_hexagonal_phase_equiaxed():
    ...
    err = sc.GenerateStatsData(dca, "Primary", "Primary", 0, 0, 0,
                               1, 2.3, 0.4, 4, 3, 10.5,
    ...
    err = sc.WriteDREAM3DFile(sd.GetBuildDirectory() + "/Debug/Data/Output/Synthetic/01_CubicSingleEquiaxedOut.dream3d",
                              dca)
    if err < 0:

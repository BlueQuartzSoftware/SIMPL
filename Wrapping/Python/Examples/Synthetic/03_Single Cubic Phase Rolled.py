...
def single_cubic_phase_rolled():
    ...
    err = sc.GenerateStatsData(dca, "Primary", "Primary", 0, 1, 1,
                               1, 2.3, 0.4, 4, 3, 10.5,
    ...
    err = sc.WriteDREAM3DFile(sd.GetBuildDirectory() + "/Debug/Data/Output/Synthetic/03_CubicSingleRolledOut.dream3d",
                              dca)
    if err < 0:

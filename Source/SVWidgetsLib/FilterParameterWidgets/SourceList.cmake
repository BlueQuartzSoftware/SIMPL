...
foreach(FPW ${SIMPLView_PARAMETER_WIDGETS})
  ...
  file(APPEND ${FILTER_PARAMETER_CODEGEN_FILE} "  return {${FPW}CodeGenerator::New(humanLabel, propertyName, fpCategory, initValue)};\n}\n")

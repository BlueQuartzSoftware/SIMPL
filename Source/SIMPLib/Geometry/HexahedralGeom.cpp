...
QString HexahedralGeom::getInfoString(SIMPL::InfoStringFormat format)
{
  ...
  case SIMPL::HtmlFormat:
    ...
    ss << "<tr " << bgColorLabel << "><th align=\"right\">Number of Hexahedra</th><td>" << getNumberOfHexas() << "</td></tr>";
    ss << "<tr " << bgColorLabel << "><th align=\"right\">Number of Vertices</th><td>" << getNumberOfVertices() << "</td></tr>";
    break;
  default:
    ss << "Requested Hexahedral Geometry information string format is not supported. " << format;
    break;
  }

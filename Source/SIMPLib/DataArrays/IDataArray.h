...
public:
   ...
   * @return
   */
  bool copyFromArray(size_t destTupleOffset, IDataArrayShPtrType sourceArray);
   ...
   * @return
   */
  virtual bool copyFromArray(size_t destTupleOffset, IDataArrayShPtrType sourceArray, size_t srcTupleOffset, size_t totalSrcTuples) = 0;
   ...
   * @return
   */
  virtual IDataArrayShPtrType deepCopy(bool forceNoAllocate = false) = 0;

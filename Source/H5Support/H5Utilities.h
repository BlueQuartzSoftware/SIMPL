...
public:
   ...
   */
  static bool probeForAttribute(hid_t loc_id, const std::string& obj_name, const std::string& attr_name);
   ...
   * @return Negative value is error
   */
  static herr_t getAllAttributeNames(hid_t loc_id, const std::string& obj_name, std::list<std::string>& names);

...
void HttpListener::listen()
{
  ...
  {
    Q_FOREACH(const QNetworkInterface& netInterface, QNetworkInterface::allInterfaces())
    {
      QNetworkInterface::InterfaceFlags flags = netInterface.flags();
      if(static_cast<bool>(flags & QNetworkInterface::IsRunning) && !static_cast<bool>(flags & QNetworkInterface::IsLoopBack))
      {
        Q_FOREACH(const QNetworkAddressEntry& address, netInterface.addressEntries())
        {
